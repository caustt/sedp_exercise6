...
static int _cffi_d_process(int x0)
{
  return process(x0);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_process(PyObject *self, PyObject *arg0)
{
  int x0;
  int result;
  PyObject *pyresult;
...
#else
#  define _cffi_f_process _cffi_d_process
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "process", (void *)_cffi_f_process, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_O, 0), (void *)_cffi_d_process },
};
